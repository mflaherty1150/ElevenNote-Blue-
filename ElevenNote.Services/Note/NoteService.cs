...
namespace ElevenNote.Services.Note
{
    public class NoteService : INoteService
    {
        ...
        public async Task<bool> CreateNoteAsync(NoteCreate request)
        {
            ...
            // Again, this one (1) line replace the seven (7) lines above it
        ...
        public async Task<IEnumerable<NoteListItem>> GetAllNotesAsync()
        {
            var notes = await _dbContext.Notes
                ...
                // })
                .Select(entity => _mapper.Map<NoteListItem>(entity)) // with AutoMap, this line replaces the above six (6) lines
                .ToListAsync();
        ...
        public async Task<NoteDetail> GetNoteByIdAsync(int noteId)
        {
            ...
            // };
            return noteEntity is null ? null : _mapper.Map<NoteDetail>(noteEntity); // Again, this line replaces the eight (8) above it.
        }
        ...
        public async Task<bool> UpdateNoteAsync(NoteUpdate request)
        {
            ...
            // If the Any check returns false, then we know the Note either does not exist or the note is not owned by the user
            if (!noteIsUserOwned)
                return false;
